...
def updateUser(request, pk):
    ...
    if request.method == 'POST' and request.POST.get('user_role') != '-':
        ...
        return redirect('core.manage_users')
    return render(request=request, template_name='users/user_registration_form.html', context=context)
...
def updateUserRole(request, pk):
    ...
    return render(request=request, template_name='user_role/user_role_update.html', context=context)
